                                ...
                                @foreach ($category->games as $game)
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            @if($game->cover_image)
                                                <img src="{{ str_starts_with($game->cover_image, 'http') ? $game->cover_image : asset('storage/' . $game->cover_image) }}" alt="{{ $game->title }}" class="w-16 h-16 object-cover rounded">
                                            @else
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <a href="{{ route('games.edit', $game) }}" class="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-600 mr-3">{{ __('Edit') }}</a>
