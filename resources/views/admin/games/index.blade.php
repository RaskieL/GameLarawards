                            ...
                            @forelse ($games as $game)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div
                                            class="h-12 w-12 rounded bg-gray-200 flex-shrink-0 overflow-hidden border border-gray-300 dark:border-gray-600">
                                            @if($game->cover_image)
                                                <img class="h-full w-full object-cover"
                                                    src="{{ asset('storage/' . $game->cover_image) }}" alt="{{ $game->title }}">
                                            @else
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm font-bold text-gray-900 dark:text-gray-100">{{ $game->title }}
                                        </div>
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex flex-wrap gap-1">
                                            @forelse($game->categories as $category)
                                                <span
                                                    class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-indigo-100 text-indigo-800 dark:bg-indigo-900 dark:text-indigo-200 border border-indigo-200 dark:border-indigo-800">
                                                    {{ $category->name }}
                                                </span>
                                            @empty
